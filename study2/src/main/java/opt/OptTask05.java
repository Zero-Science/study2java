...
public class OptTask05 extends AiTaskExecutor {
	private Logger logger = Logger.getLogger(OptTask05.class);
	...
	protected String makePrompt() {
		...
		String prompt = "请用[" + this.word + "]这个日语单词出一个日译中的六选一的选择题，中间有一个正确答案和五个混淆项。\n" +
				"题目是一句带有[" + this.word + "]的句子，要求选出这句话中[" + this.word + "]的中文含义。\n" +
				"请按下面格式输出，不需要其他多余文字。\n" +
				"【题目】: XXXXX\n" +
				"【正确翻译】: XXXXX\n" +
				"【混淆干扰项1】: XXXXX\n" +
